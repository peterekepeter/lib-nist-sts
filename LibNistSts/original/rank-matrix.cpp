...
void
perform_elementary_row_operations(int flag, int i, int M, int Q, unsigned char **A)
{
	int		j, k;
...
int
swap_rows(int i, int index, int Q, unsigned char **A)
{
	int			p;
	unsigned char	temp;
...
int
find_unit_element_and_swap(int flag, int i, int M, int Q, unsigned char **A)
{
	int		index, row_op = 0;
...
int
determine_rank(int m, int M, int Q, unsigned char **A)
{
...
void
def_matrix(int M, int Q, unsigned char **m, int k, const unsigned char* epsilon)
{
	int		i, j;
...
void
delete_matrix(int M, unsigned char **matrix)
{
	int		i;
