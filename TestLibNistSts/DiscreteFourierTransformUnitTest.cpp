...
{
	TEST_CLASS(DiscreteFourierTransformUnitTest)
	{
	public:
		...
		TEST_METHOD(DiscreteFourierTransformCompareVersions)
		{
			...
			DiscreteFourierTransform(test1);
			DiscreteFourierTransform(test2);
